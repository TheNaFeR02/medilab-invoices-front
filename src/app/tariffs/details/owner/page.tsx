    ...
    <>
      ...
      <Grid container spacing={6}> {/* display: 'flex', justifyContent: 'space-between', */}
        <Grid item xs={8.5}>
          ...
          <Box sx={{ width: '100%' }}>
            <h4 style={{ marginBottom: '0' }}>Comments & Attachments</h4>
            <hr style={{ margin: '0' }} />
            <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
              <Box sx={{ display: 'flex', gap: '1.5em', fontWeight: '400' }}>
                <p style={{ color: '#827379' }}>No comments present for this invoice</p>
              </Box>
              <Box sx={{
                display: 'flex',
                '& button': { textTransform: 'none', backgroundColor: 'transparent', color: '#884B6B', fontWeight: '600' }
          ...
          {/* End Comments & Attachments */}
          {/* Activity Log */}
          <Box sx={{ width: '100%' }}>
            <h4 style={{ marginBottom: '0' }}>Activity Log</h4>
            <hr style={{ margin: '0' }} />
            <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
              <Box sx={{ display: 'flex', gap: '1.5em', fontWeight: '400' }}>
                <p style={{ color: '#827379' }}>No activity logs found for this invoice</p>
              </Box>
            </Box>
          </Box>
          {/* End Activity Log */}
            ...
            <Box sx={{
              ...
              <Box sx={{
                ...
                <Box sx={{ width: '80%', display: 'flex', alignItems: 'center', flexDirection: 'column', gap: '1px' }}>
                  <Button fullWidth variant='outlined' sx={{ mb: '0', borderColor: '#827379', fontWeight: '600' }}>Send Email</Button>
                  <p style={{ margin: '0', alignSelf: 'self-start', width: '80%', fontSize: '0.9em' }}>Email this Invoice</p>
                </Box>
                <Box sx={{ width: '80%', display: 'flex', alignItems: 'center', flexDirection: 'column', gap: '1px' }}>
                  <Button fullWidth variant='outlined' sx={{ mb: '0', borderColor: '#827379', fontWeight: '600' }}>View as PDF</Button>
                  <p style={{ margin: '0', alignSelf: 'self-start', width: '80%', fontSize: '0.9em' }}>View the PDF invoice senty to your costumer</p>
                </Box>
                <Box sx={{ width: '80%', display: 'flex', alignItems: 'center', flexDirection: 'column', gap: '1px' }}>
                  <Button fullWidth variant='outlined' sx={{ mb: '0', borderColor: '#827379', fontWeight: '600' }}>Create Credit Note</Button>
                  <p style={{ margin: '0', alignSelf: 'self-start', width: '80%', fontSize: '0.9em' }}>Create credit note for this invoice</p>
                </Box>
                <Box sx={{ width: '80%', display: 'flex', alignItems: 'center', flexDirection: 'column', gap: '1px' }}>
                  <Button fullWidth variant='outlined' sx={{ mb: '0', borderColor: '#827379', fontWeight: '600' }}>Create Debit Note</Button>
                  <p style={{ margin: '0', alignSelf: 'self-start', width: '80%', fontSize: '0.9em' }}>Create debit note for this invoice</p>
                </Box>
                <Box sx={{ width: '80%', display: 'flex', alignItems: 'center', flexDirection: 'column', gap: '1px' }}>
                  <Button disabled fullWidth variant='outlined' sx={{ mb: '0', borderColor: '#827379', fontWeight: '600' }}>Edit Invoice</Button>
                  <p style={{ margin: '0', alignSelf: 'self-start', width: '80%', fontSize: '0.9em', opacity: '0.5' }}>Edit this invoice</p>
                </Box>
              </Box>
            </Box>
